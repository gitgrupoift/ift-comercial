...
class CustomType {
    ...
    function register_post_type() {
        ...
        $labels = array(
            ...
            'add_new'            => __( 'Nova', $this->textdomain ),
            'add_new_item'       => sprintf( __( 'Nova %s', $this->textdomain ), $singular ),
            'edit_item'          => sprintf( __( 'Editar %s', $this->textdomain ), $singular ),
            'new_item'           => sprintf( __( 'Nova %s', $this->textdomain ), $singular ),
            'view_item'          => sprintf( __( 'Ver %s', $this->textdomain ), $singular ),
            'search_items'       => sprintf( __( 'Procurar %s', $this->textdomain ), $plural ),
